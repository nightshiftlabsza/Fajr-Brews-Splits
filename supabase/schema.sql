...
-- Final privacy model: owner/admin raw orders, participant scoped projection.
ALTER TABLE public.orders
...
ALTER PUBLICATION supabase_realtime ADD TABLE public.roasters;
